...
const SignIn = () => {
  ...
  return (
    <div className="absolute inset-0 w-full bg-[#f1f1f1] bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] ">
